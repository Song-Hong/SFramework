...
namespace Song.Core.Module.Server
{
    ...
    public class SongTcpClient
    {
        ...
        public static SongTcpClient Connect(int port, Action<string> onReceived=null)
        {
            var ip = GetMainLocalIP();
            var songTcpServer = Connect(ip,port,onReceived);
        ...
        /// <param name="port">端口号</param>
        /// <param name="onReceived">接收到消息时</param>
        public static SongTcpClient Connect(string ip, int port, Action<string> onReceived=null)
        {
            var songTcpServer = Connect(ip,port);
            if(onReceived!=null)
        ...
        /// <param name="ip">IP地址</param>
        /// <param name="port">端口号</param>
        public static SongTcpClient Connect(string ip, int port)
        {
            //创建一个负责监听IP和端口号的Socket
            var songTcpClient = new SongTcpClient();
