...
namespace SFramework.Core.Extends.DB
{
    ...
    /// Sqlite数据库操作类
    /// </summary>
    public class SongSqlite : IDisposable
    {
        /// <summary>
        /// 数据库连接
        /// </summary>
        ...
        public SongSqlite(string dbPath)
        {
        ...
        public bool CreateTable(string tableName, string columnDefinitions)
        {
            ...
            {
                UnityEngine.Debug.LogError($"创建表失败: {ex.Message}");
                return false;
            }
        }
        ...
        public bool DropTable(string tableName)
        {
            ...
            {
                UnityEngine.Debug.LogError($"删除表失败: {ex.Message}");
                return false;
            }
        }
        ...
        public bool Insert(string tableName, string columns, string values)
        {
            ...
            {
                UnityEngine.Debug.LogError($"插入数据失败: {ex.Message}");
                return false;
            }
        }
        ...
        public int Update(string tableName, string setClause, string whereClause = "")
        {
            ...
            {
                UnityEngine.Debug.LogError($"更新数据失败: {ex.Message}");
                return -1;
            }
        }
        ...
        public int Delete(string tableName, string whereClause = "")
        {
            ...
            {
                UnityEngine.Debug.LogError($"删除数据失败: {ex.Message}");
                return -1;
            }
        }
        ...
        public bool Exists(string tableName, string whereClause)
        {
            ...
            {
                UnityEngine.Debug.LogError($"查询数据存在性失败: {ex.Message}");
                return false;
            }
        }
