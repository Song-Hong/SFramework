...
namespace SFramework.SFNet.Editor.Replace
{
    ...
    /// TCP服务器编辑器
    /// </summary>
    [CustomEditor(typeof(SfHttpServerMono))]
    public class SfHttpServerMonoEditor : UnityEditor.Editor
    {
        /// <summary>
        /// 根元素
        /// </summary>
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            _rootElement.Add(new SfTitleEditor("SFramework HTTP 服务器"));
            
            // 
            var serverMono = target as SfHttpServerMono;
